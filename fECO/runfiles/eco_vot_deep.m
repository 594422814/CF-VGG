function results = eco_vot_deep(seq, res_path, bSaveImage, parameters)
...
cnn_params.nn_name = 'CF_VGGMnew.mat';
...
cnn_params.compressed_dim = [8 32];            % Compressed dimensionality of each output layer
...
params.min_image_sample_size = 250^2;   % Minimum area of image samples
