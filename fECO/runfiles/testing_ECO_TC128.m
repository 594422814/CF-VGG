function results = testing_ECO_TC128(seq, res_path, bSaveImage, parameters)
...
% cnn_params.nn_name = ['CF_VGGM_online_', seq.name, '.mat']; % Name of the network

cnn_params.nn_name = 'CF_VGGMnew_epoch_40.mat';
% cnn_params.nn_name = 'CF_VGGM_tracking_epoch_3.mat';
% cnn_params.nn_name = 'imagenet-vgg-m-2048.mat'; % Name of the network

cnn_params.output_layer = [3 10 14];               % Which layers to use
...
cnn_params.compressed_dim = [8 32 32];            % Compressed dimensionality of each output layer
