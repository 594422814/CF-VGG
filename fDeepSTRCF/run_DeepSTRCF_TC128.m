function results = run_DeepSTRCF_TC128(seq, res_path, bSaveImage)
...
cnn_params.nn_name = 'CF_VGGMnew_epoch_40.mat'; % Name of the network
% cnn_params.nn_name = 'CF_VGGM_tracking_epoch_3.mat'; % Name of the network
...
params.number_of_scales = 3;  %3          % Number of scales to run the detector
params.scale_step = 1.02;      %1.02         % The scale factor
